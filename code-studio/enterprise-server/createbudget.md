---
title: Create Budget in Syncfusion Sync fusion Code
description: Learn how to configure team and individual user budgets, set budget periods with auto-renewal, and set up usage alerts in Syncfusion Sync fusion Code Enterprise Server.
...
The Budget feature in Sync fusion Code enables administrators to allocate and monitor AI usage budgets for teams and individual users. This helps organizations manage costs effectively and optimize AI resource utilization.
...
- Open the **Sync fusion Code** page and navigate to the **Budget** page from the left sidebar.
