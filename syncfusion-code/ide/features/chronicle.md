...
## Related Features
- [Agent Mode](/syncfusion-code/features/agent) - Chronicle helps you trace what the agent did across sessions. Use it to review agent-driven changes or reconstruct the sequence of edits made during an autonomous task.
- [Checkpoints](/syncfusion-code/features/checkpoints) - Use Checkpoints alongside Chronicle to both restore workspace states and understand what changed between sessions.
