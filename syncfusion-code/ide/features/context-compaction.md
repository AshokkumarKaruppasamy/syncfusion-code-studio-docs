...
## Related Features
- [Agent Mode](/syncfusion-code/features/agent) - Long agent sessions can accumulate a large amount of context. Use `/compact` to trim the history and keep the agent focused on the current task.