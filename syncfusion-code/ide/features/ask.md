...
- [Edit Mode](/syncfusion-code/features/edit) - Context-aware file editing with workspace integration
- [Agent Mode](/syncfusion-code/features/agent) - Multi-step task automation with tool execution
