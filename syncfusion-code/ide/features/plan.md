...
* The command will appear in the chat box and the mode will automatically switch to **Agent Mode** . Click Enter for execute your plan.
    ...
    **Note:** For more information, refer to the [Syncfusion Code Studio Agent Mode](/syncfusion-code/features/agent)
...
* Automatically activated after plan approval
    ...
    **Note:** For more information on agent mode features, visit the [Syncfusion Code Studio Agent Mode](/syncfusion-code/features/agent).
...
* Use Ask when you want to understand how something works, explore ideas, or get help with coding tasks
    ...
    **Note:** For more information on ask mode features, visit the [Syncfusion Code Studio Ask Mode](/syncfusion-code/features/ask).
