...
1. **Syncfusion Code Studio is installed**  
   If it’s not installed, refer to the [installation guide](/syncfusion-code/getting-started/install-and-configuration) to set it up properly.
...
You can also create [custom agents](/syncfusion-code/reference/configure-properties/custom-agents) for specialized workflows.
...
*Learn more about [Autocomplete](/syncfusion-code/features/autocomplete)*
...
*Learn more about [Ask](/syncfusion-code/features/ask)*
...
*Learn more about [Edit](/syncfusion-code/features/edit)*
...
*Learn more about [Agent](/syncfusion-code/features/agent)*
...
*Learn more about [Plan](/syncfusion-code/features/plan)*
...
*Learn more about [Inline Chat](/syncfusion-code/features/inlinechat)*
...
*Learn more about [Add Context](/syncfusion-code/features/add-context)*

## Next Steps

Now that you've explored the basics:

- Learn how to create your first automated change with [Agent](/syncfusion-code/features/agent).  
