...
> **Note:** Session history created prior to v2.0.0 cannot be migrated to the Code Studio v2.0.0+ session history. Refer to the [v2.0.0 release notes](/syncfusion-code/release-notes/v2.0.0) for migration details.
