...
If you have [custom agents](/syncfusion-code/reference/configure-properties/custom-agents) or settings, backup before proceeding.
...
2. Reinstall Syncfusion Code Studio, refer to the [Syncfusion Code Studio Install and Configure](/syncfusion-code/getting-started/install-and-configuration) 
