...
> **Note:** Agent files from v1.x.x aren’t migrated automatically in v2.0.0+. To restore Agent rules, follow the resolution steps below. Refer to the [v2.0.0 release notes](/syncfusion-code/release-notes/v2.0.0) for migration details.
