...
For a deeper understanding of the features used in this tutorial, see [Custom Agents](/syncfusion-code/reference/configure-properties/custom-agents) and [Checkpoints](/syncfusion-code/features/checkpoints).
...
- Generate your first code change: Walk through creating and applying a safe code diff with the agent. See [Generate Your First Code Using Agent](/syncfusion-code/tutorials/generate-your-first-code-using-agent).
- Fix bugs with AI: Locate, explain, and patch defects end-to-end. See [Fixing Bugs with AI](/syncfusion-code/tutorials/fixing-bugs-with-ai).
- Accelerate code reviews: Summarize diffs, surface risks, and propose improvements. See [Accelerate Code Reviews](/syncfusion-code/tutorials/accelerate-code-reviews).
