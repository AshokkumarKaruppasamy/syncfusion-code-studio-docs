...
- Use Code Studio's [Inline Chat](/syncfusion-code/features/inlinechat) to understand unfamiliar or complex code instantly
...
- Use [Agent mode](/syncfusion-code/features/agent) to perform multi-file, large-scale refactoring automatically
...
- **[Ask mode](/syncfusion-code/features/ask)**: For questions, explanations, and single-file changes
- **[Agent mode](/syncfusion-code/features/agent)**: For complex, multi-file refactoring that requires the AI to autonomously plan and execute changes across multiple files

> **Tip:** Use [Inline Chat](/syncfusion-code/features/inlinechat) for quick, focused changes to code you've selected. Use [Agent mode](/syncfusion-code/features/agent) in the Chat Panel for larger refactoring tasks that involve multiple files.

## Steps to Refactor Code

### Step 1: Understand Code Before You Refactor

Before changing any code, you must understand what it does. Code Studio's [Inline Chat](/syncfusion-code/features/inlinechat) gives you an instant, plain-English explanation of any selected block of code — removing the guesswork before you begin.
...
For bigger refactoring jobs that span multiple files — such as standardizing error handling patterns, migrating to a new API, or updating deprecated library methods across your entire codebase — **[Agent mode](/syncfusion-code/features/agent)** is the right tool.
...
4. Select **[Agent](/syncfusion-code/features/agent)** from the mode selector dropdown.
...
6. Watch [Agent mode](/syncfusion-code/features/agent) work. It will automatically:
...
- [Generate Your First Code Change Using Agent](/syncfusion-code/tutorials/generate-your-first-code-using-agent) — Let AI write new code for you.
- [Quick Fix Error Guide](/syncfusion-code/how-to-guides/quick-fix-error) — Catch and fix bugs early with AI assistance.
- [Agent Mode](/syncfusion-code/features/agent) — Explore advanced Agent workflows and capabilities.
