...
For more details on the features covered in this tutorial, see [User & Teams Management](/syncfusion-code/enterprise-server/userandteams) and [Dashboard Analytics](/syncfusion-code/enterprise-server/dashboard).

## Prerequisites

Before starting, ensure you have:

- **Code Studio Enterprise account** — If not set up, see [Enterprise Server Getting Started Guide](/syncfusion-code/enterprise-server/getting-started)
...
**To create teams with detailed step-by-step instructions and screenshots,** see [User & Teams - Team Management Documentation](/syncfusion-code/enterprise-server/userandteams)
...
**To invite users with detailed step-by-step instructions and screenshots,** see [User & Teams Documentation](/syncfusion-code/enterprise-server/userandteams)
...
**To monitor token usage with detailed instructions on accessing all metrics and reports,** see [Dashboard Documentation](/syncfusion-code/enterprise-server/dashboard)
...
**To perform member management tasks with detailed workflows and screenshots,** see [User & Teams Documentation](/syncfusion-code/enterprise-server/userandteams)
