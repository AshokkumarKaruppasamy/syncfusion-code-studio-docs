...
- [Agent](https://help.syncfusion.com/syncfusion-code/features/agent) – Discover advanced workflows and capabilities of the agent  
- [Custom Agent](https://help.syncfusion.com/syncfusion-code/reference/configure-properties/custom-agents) – Establish clear rules and instructions for consistent and constrained behavior  