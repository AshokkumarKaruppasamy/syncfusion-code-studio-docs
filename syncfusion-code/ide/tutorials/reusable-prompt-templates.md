...
To create and setup the custom prompt, see [Custom Prompts](/syncfusion-code/reference/configure-properties/custom-prompt) for detailed steps.
...
To create and setup the agents, see [Custom Agents](/syncfusion-code/reference/configure-properties/custom-agents) for detailed steps.
...
To create and setup the custom instructions, see [Custom Instruction](/syncfusion-code/reference/configure-properties/custom-instructions) for detailed steps.
...
To create and setup the skills, see [Skills](/syncfusion-code/reference/configure-properties/skills) for detailed steps.
