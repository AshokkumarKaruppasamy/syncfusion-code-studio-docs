...
- [Checkpoints and Editing Requests](/syncfusion-code/features/checkpoints) - Restore your workspace to earlier states within a single session
- [Agent Mode](/syncfusion-code/features/agent) - Combine forked sessions with agent mode for autonomous exploration of different approaches
- [Manage Chat Session](/syncfusion-code/how-to-guides/manage-chat-session) - Organize, rename, and manage multiple chat sessions effectively
