...
For a full list of supported models and side-by-side feature comparisons, see the [Model Comparison](/syncfusion-code/reference/configure-properties/model-comparison) page in the reference section.
...
1. **Explore Advanced Features**: Try using the [Agent](/syncfusion-code/features/agent) feature with reasoning-focused models like GPT-5 or GPT-5.2 for autonomous multi-step workflows.
