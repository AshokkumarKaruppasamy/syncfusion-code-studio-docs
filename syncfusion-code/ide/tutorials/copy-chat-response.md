...
### What's Next
- [Agent](https://help.syncfusion.com/syncfusion-code/features/agent) – Explore advanced workflows and capabilities of the agent  
- [Manage Chat Session](https://help.syncfusion.com/syncfusion-code/how-to-guides/manage-chat-session) - Organize, rename, and manage multiple chat sessions effectively
