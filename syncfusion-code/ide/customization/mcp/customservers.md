...
> **Note:** Custom servers installed via **npm**, **pip**, or **Docker** rely on AI model–assisted execution. If your [Premium model usage budget](/syncfusion-code/how-to-guides/buy-more-credits) is exhausted, these configurations can’t be completed until additional budget is available.
