...
1. **For MCP Tools** - MCP servers must be installed and configured before they can be used. See [MCP Marketplace](/syncfusion-code/reference/configure-properties/mcp/marketplace) for installation instructions.
