...
## New Features
### Plan Mode
The Code Studio IDE now introduces [Plan Mode](/syncfusion-code/features/plan), a smarter way to start coding with confidence. Instead of jumping straight into implementation, Plan Mode helps you research tasks, outline requirements, and break work into clear steps. You'll receive a draft plan to review, edit, or approve—ensuring nothing changes in your code until you're ready. By beginning with a clear plan, you reduce mistakes, stay organized, and make complex projects easier to manage. 
 
<img src="./releasenotes-images/PlanMode.gif" alt="release notes" >

### Custom Agents
[Custom Agents](/syncfusion-code/reference/configure-properties/custom-agents) let you set up the AI to act like different roles for your project. You can make one agent a security reviewer, performance checker, or a solution architect. Each agent follows its own rules and tools, so the AI gives answers that fit the job. You can also switch between agents with one click—like moving from coding to performance checking or handing off to a code reviewer—while keeping all the context.
 
<img src="./releasenotes-images/custom-agent.png" alt="release notes" >

### Inline Chat
[Inline Chat](/syncfusion-code/features/inlinechat) giving you AI assistance directly inside the editor. You can request code generation, make inline edits, or get help with commands without switching to the Chat panel. This in-context workflow speeds up coding, improves accuracy, and reduces interruptions—keeping you fully focused while working on your project. 
 
<img src="./releasenotes-images/INLINECHAT.webp" alt="release notes" >

### Custom Instructions
Easily tailor the AI assistant to your project needs with [Custom Instructions](/syncfusion-code/reference/configure-properties/custom-instructions). Define coding standards, architecture preferences, and project-specific guidelines, so the assistant delivers consistent, context-aware responses without assumptions. This ensures smoother collaboration. 
 
<img src="./releasenotes-images/custom-instructions.png" alt="release notes" >

### Custom Prompts
Boost productivity with reusable prompt files for common development tasks. From code generation to reviews and scaffolding, [Custom Prompts](/syncfusion-code/reference/configure-properties/custom-prompt)  let you build a library of standardized workflows that can be run directly in chat—ensuring consistency and faster execution across projects.

<img src="./releasenotes-images/custom-prompt.png" alt="release notes" >
 
### Add Contexts
Code Studio now introduces a redesigned [Add Context](/syncfusion-code/features/add-context) experience that makes it simple to give the AI the right information. You can attach files, folders, problems, symbols, screenshots, or tools directly from the chat. 
...
The [User Settings](/syncfusion-code/reference/configure-properties/usersettings) page has been redesigned to provide a more modern, consolidated interface that makes managing Code Studio simpler and more intuitive. The new UI brings everything together in one place with clear categories and instant changes. 
...
## Additional Notes
- For detailed guidance on using Custom Agents, Custom Instructions, and other new features, please refer to our [help documentation](/syncfusion-code/getting-started/feature-summary).
