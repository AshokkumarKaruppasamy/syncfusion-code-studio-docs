...
> **Prerequisites:** 
> - Syncfusion Code Studio must be installed. If not, see the [installation guide](/syncfusion-code/getting-started/install-and-configuration).
...
- **Build Real Projects:** Start developing Go applications with full debugging support - see [tutorials](/syncfusion-code/tutorials/generate-your-first-code-using-agent) to get started
- **Leverage AI Features:** Use Code Studio's [autocomplete](/syncfusion-code/features/autocomplete), [code explanation](/syncfusion-code/features/ask), and refactoring capabilities to speed up development
- **Explore Agent Mode:** For complex multi-package projects, try [Agent mode](/syncfusion-code/features/agent) for advanced refactoring and architectural improvements
- **Learn More:** Check out the [Quick Start Guide](/syncfusion-code/getting-started/quick-start) and [features overview](/syncfusion-code/features/generatecode) for additional capabilities
