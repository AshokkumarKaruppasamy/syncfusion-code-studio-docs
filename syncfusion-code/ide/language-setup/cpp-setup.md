...
- **Build Real Projects:** Start developing C++ applications with full debugging support - see [tutorials](/syncfusion-code/tutorials/generate-your-first-code-using-agent) to get started
...
- **Explore Agent Mode:** For complex multi-file projects, try [Agent mode](/syncfusion-code/features/agent) for advanced refactoring and architectural improvements
