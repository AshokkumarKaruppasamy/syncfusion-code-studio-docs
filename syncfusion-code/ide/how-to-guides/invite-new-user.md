...
<img src="./howtoguide-images/inviteuser1.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

### Step 3 : Click Invite Users
- Click the **Invite Users** button at the top of the Users List.

<img src="./howtoguide-images/inviteuser2.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

- A dialog box will appear.

<img src="./howtoguide-images/inviteuser3.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

### Step 4 : Select a Team
- Choose the team to which the new user should be added.

<img src="./howtoguide-images/inviteuser4.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

- If no teams exist, click **Add Team**.

<img src="./howtoguide-images/inviteuser5.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

- Enter a team name and click **Add Team**.

<img src="./howtoguide-images/inviteuser6.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

### Step 5 : Select Role
- Choose the user’s role (e.g., User, Team Lead, Admin).

<img src="./howtoguide-images/inviteuser7.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

### Step 6 : Enter User’s Email
- Type the email address of the person you want to invite and click **Add**.

<img src="./howtoguide-images/inviteuser8.png" alt="inviteuser" style="display:block; margin: 12px auto;" />

### Step 7 : Send the Invitation
- Click **Invite** to send the request.

<img src="./howtoguide-images/inviteuser9.png" alt="inviteuser" style="display:block; margin: 12px auto;" />
