...
* Syncfusion Code Studio is installed and configured on your system. If you have not yet downloaded Code Studio, refer to the [Syncfusion Code Studio Install and Configure](https://help.syncfusion.com/syncfusion-code/getting-started/install-and-configuration)
...
* Go to the [Models](https://app.sfcodestudio.com/models) section and click Manage Default Settings.
 ...
 >**Note**: If you have not configured your model, please refer to [Configure LLM Providers and Models in Syncfusion Code Studio]( https://help.syncfusion.com/syncfusion-code/enterprise-server/providersandmodels ) for guidance on adding models.
