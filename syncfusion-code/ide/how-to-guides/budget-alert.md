...
- **Admin Access:** Can configure alerts and create, edit, and assign budgets.
...
- **Budget configured:** Refer to the [Create Budget](/syncfusion-code/enterprise-server/createbudget) guide to create and assign a budget for the team or the individual user before setting an alert.
