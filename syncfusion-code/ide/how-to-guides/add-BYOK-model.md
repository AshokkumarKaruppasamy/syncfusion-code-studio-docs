...
- *(Optional)* An OpenRouter API key for accessing multiple models through a single integration. Follow the detailed instructions [here](/syncfusion-code/enterprise-server/freemodel) to obtain an OpenRouter API key.
...
- Learn how to [configure default models](/syncfusion-code/how-to-guides/Configure-default-model) for your team.
- Explore [provider and model management](/syncfusion-code/enterprise-server/providersandmodels) for advanced configurations.
- [Free Models with OpenRouter](/syncfusion-code/enterprise-server/freemodel)
- [User and Team Management](/syncfusion-code/enterprise-server/userandteams)
