...
- OpenRouter API Key - Follow the detailed instructions [here](/syncfusion-code/enterprise-server/freemodel) to obtain an OpenRouter API key and the list of recommended free models for integration.
